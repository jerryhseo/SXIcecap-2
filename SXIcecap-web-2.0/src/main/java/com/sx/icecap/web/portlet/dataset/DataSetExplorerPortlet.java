...
import com.sx.icecap.security.permission.resource.dataset.DataSetResourcePermissionHelper;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Data Set Explorer",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=" + JSPPath.DATASET_EXPLORER,
		"javax.portlet.name=" + WebPortletKey.DATASET_EXPLORER,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class 
)
public class DataSetExplorerPortlet extends MVCPortlet {

	@Override
	public void doView(
			RenderRequest renderRequest, RenderResponse renderResponse)
		throws IOException, PortletException {
		System.out.println("DataSetExplorerPortlet....... ");
		...
		for (ResourceAction resourceAction : resourceActions) {
			...
			boolean hasPermission =DataSetResourcePermissionHelper.contains(permissionChecker, themeDisplay.getScopeGroupId(), actionId);
