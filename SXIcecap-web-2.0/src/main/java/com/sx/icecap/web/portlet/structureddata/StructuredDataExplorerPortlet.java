package com.sx.icecap.web.portlet.structureddata;
...
@Component(
	...
	property = {
		...
		"javax.portlet.init-param.view-template=/html/SDExplorer/structured-data-explorer.jsp",
...
public class StructuredDataExplorerPortlet extends MVCPortlet {
