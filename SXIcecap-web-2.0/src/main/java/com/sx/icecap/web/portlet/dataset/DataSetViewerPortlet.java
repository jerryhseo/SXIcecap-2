...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Data Set Viewer",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=" + JSPPath.DATASET_VIEWER,
		"javax.portlet.name=" + WebPortletKey.DATASET_VIEWER,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class DataSetViewerPortlet extends MVCPortlet {
