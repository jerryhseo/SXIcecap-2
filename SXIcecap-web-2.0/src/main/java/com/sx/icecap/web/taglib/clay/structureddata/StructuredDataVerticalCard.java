package com.sx.icecap.web.taglib.clay.structureddata;
...
public class StructuredDataVerticalCard extends BaseVerticalCard {
	...
	public String getSubtitle() {
		...
		return String.valueOf(_structuredData.getPrimaryKey());
	}

	@Override
	public String getTitle() {
		return HtmlUtil.escape( String.valueOf(_structuredData.getPrimaryKey()));
	}
