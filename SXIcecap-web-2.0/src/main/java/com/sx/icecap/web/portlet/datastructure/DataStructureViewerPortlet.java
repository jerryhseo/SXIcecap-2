...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Data Structure Viewer",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template="+JSPPath.DATA_STRUCTURE_VIEWER,
		"javax.portlet.name=" + WebPortletKey.DATA_STRUCTURE_VIEWER,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class DataStructureViewerPortlet extends MVCPortlet {
	...
	public void doView(
		...
		System.out.println("DataStructureViewerPortlet - dataStructureId: " + dataStructureId);
