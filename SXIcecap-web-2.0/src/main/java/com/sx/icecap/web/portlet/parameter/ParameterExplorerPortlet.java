...
import com.sx.icecap.security.permission.resource.parameter.ParameterResourcePermissionHelper;
...
@Component(
	...
	property = {
		...
		"javax.portlet.display-name=Parameter Explorer",
		"javax.portlet.init-param.template-path=/",
		"javax.portlet.init-param.view-template=" + JSPPath.PARAMETER_EXPLORER,
		"javax.portlet.name=" + WebPortletKey.PARAMETER_EXPLORER,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class 
)
public class ParameterExplorerPortlet extends MVCPortlet {

	@Override
	public void doView(
			RenderRequest renderRequest, RenderResponse renderResponse)
		throws IOException, PortletException {
		System.out.println("ParameterExplorerPortlet....... ");
		...
		for (ResourceAction resourceAction : resourceActions) {
			...
			boolean hasPermission = ParameterResourcePermissionHelper.contains(permissionChecker, themeDisplay.getScopeGroupId(), actionId);
