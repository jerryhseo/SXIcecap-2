	...
	return (
		...
		>
			<ClayPanel.Body style={panelBodyStyle}>
				<ClayLayout.ContainerFluid view style={containerStyle}>
					<ClayLayout.Row justify="around">
						<ClayLayout.Col size={3} style={colStyles}>
							<SXText label="Id" text={id} type="INLINE_ATTACH" />
						</ClayLayout.Col>
						<ClayLayout.Col size={3} style={colStyles}>
							<SXText
								label="Name"
