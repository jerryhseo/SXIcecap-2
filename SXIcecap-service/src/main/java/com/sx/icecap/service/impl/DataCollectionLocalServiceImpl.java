 ...
 */
@Component(
			property = "model.class.name=com.sx.icecap.model.DataCollection", service = AopService.class
)
public class DataCollectionLocalServiceImpl extends DataCollectionLocalServiceBaseImpl {
	...
	public DataCollection addDataCollection (
				String dataCollectionCode, String dataCollectionVersion, Map<Locale, String> displayNameMap,
	...
	public DataCollection updateDataCollection (
				long dataCollectionId, String dataCollectionCode, String dataCollectionVersion,
	...
	public DataCollection updateStatus ( long userId, long dataCollectionId, Integer status, ServiceContext sc )
	...
	public DataCollection removeDataCollection ( long groupId, long dataCollectionId ) throws PortalException {
		...
		_structuredDataLocalService.removeStructuredDataByCollection ( groupId, dataCollectionId );
	...
	public void removeDataCollectionData ( long groupId, long dataCollectionId ) throws PortalException {
		_structuredDataLocalService.removeStructuredDataByCollection ( groupId, dataCollectionId );
	}
