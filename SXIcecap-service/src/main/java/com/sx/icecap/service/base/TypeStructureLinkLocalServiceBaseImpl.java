...
/**
 * Provides the base implementation for the type structure link local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sx.icecap.service.impl.TypeStructureLinkLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.sx.icecap.service.impl.TypeStructureLinkLocalServiceImpl
 * @generated
 */
public abstract class TypeStructureLinkLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TypeStructureLinkLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TypeStructureLinkLocalServiceUtil</code>.
	 */
	...
	public TypeStructureLink addTypeStructureLink(
		...
		return typeStructureLinkPersistence.update(typeStructureLink);
	}
	...
	public TypeStructureLink createTypeStructureLink(long dataTypeId) {
		return typeStructureLinkPersistence.create(dataTypeId);
	}
	...
	public TypeStructureLink deleteTypeStructureLink(long dataTypeId)
		...
		return typeStructureLinkPersistence.remove(dataTypeId);
	}
	...
	public TypeStructureLink deleteTypeStructureLink(
		...
		return typeStructureLinkPersistence.remove(typeStructureLink);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TypeStructureLink.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return typeStructureLinkPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return typeStructureLinkPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return typeStructureLinkPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return typeStructureLinkPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TypeStructureLink fetchTypeStructureLink(long dataTypeId) {
		return typeStructureLinkPersistence.fetchByPrimaryKey(dataTypeId);
	}
	...
	public TypeStructureLink getTypeStructureLink(long dataTypeId)
		...
		return typeStructureLinkPersistence.findByPrimaryKey(dataTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TypeStructureLink.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TypeStructureLink.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return typeStructureLinkLocalService.deleteTypeStructureLink(
			(TypeStructureLink)persistedModel);
	}

	public BasePersistence<TypeStructureLink> getBasePersistence() {
		return typeStructureLinkPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return typeStructureLinkPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TypeStructureLink> getTypeStructureLinks(int start, int end) {
		return typeStructureLinkPersistence.findAll(start, end);
	}
	...
	public int getTypeStructureLinksCount() {
		return typeStructureLinkPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TypeStructureLinkLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		typeStructureLinkLocalService = (TypeStructureLinkLocalService)aopProxy;

		_setLocalServiceUtilService(typeStructureLinkLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TypeStructureLinkLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				typeStructureLinkPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TypeStructureLinkLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, typeStructureLinkLocalService);
		}
	...
	protected TypeStructureLinkLocalService typeStructureLinkLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TypeStructureLinkLocalServiceBaseImpl.class);
