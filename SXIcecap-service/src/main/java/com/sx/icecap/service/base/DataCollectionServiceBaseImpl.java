...
import com.sx.icecap.service.DataCollectionService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sx.icecap.service.impl.DataCollectionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.sx.icecap.service.impl.DataCollectionServiceImpl
 * @generated
 */
public abstract class DataCollectionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DataCollectionService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DataCollectionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DataCollectionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DataCollectionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dataCollectionService = (DataCollectionService)aopProxy;

		_setServiceUtilService(dataCollectionService);
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DataCollectionServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dataCollectionService);
		}
	...
	@Reference
	protected com.sx.icecap.service.DataCollectionLocalService
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DataCollectionServiceBaseImpl.class);
