 ...
 */
@Component(
			property = "model.class.name=com.sx.icecap.model.StructuredData", service = AopService.class
)
public class StructuredDataLocalServiceImpl extends StructuredDataLocalServiceBaseImpl {
	...
	public StructuredData addStructuredData (
				long dataCollectionId, long dataSetId, long dataTypeId, boolean multiple, long startIndex, int count,
	...
	public StructuredData updateStructuredData (
				long structuredDataId, long dataCollectionId, long dataSetId, long dataTypeId, boolean multiple,
				long startIndex, int count, String data, int status, ServiceContext sc
	) throws PortalException {
	...
	public StructuredData updateStatus ( long userId, long structuredDataId, Integer status, ServiceContext sc )
	...
	public StructuredData removeStructuredData ( long structuredDataId, Path dataFolderPath ) throws PortalException {
		...
		try {
			SXFileUtil.deleteFolder ( dataFolderPath );
		} catch ( IOException e ) {
	...
	public List<StructuredData> getStructuredDataByCollection (
		...
		if ( status == WorkflowConstants.STATUS_ANY )
			...
			return structuredDataPersistence
						.findByDataCollectionId_G_S ( groupId, dataCollectionId, start, end, status );
	}
	...
	public List<StructuredData> getStructuredDataByCollection (
		...
		if ( status == WorkflowConstants.STATUS_ANY )
			return super.structuredDataPersistence
						.findByDataCollectionId_G ( groupId, dataCollectionId, start, end, comparator );
		else
			return structuredDataPersistence
						.findByDataCollectionId_G_S ( groupId, dataCollectionId, start, end, status, comparator );
	}
	...
	public List<StructuredData> getStructuredDataByCollectionSet (
				long groupId, long dataCollectionId, long dataSetId, int start, int end, int status
	) {
		if ( status == WorkflowConstants.STATUS_ANY )
			return super.structuredDataPersistence
						.findByCollectionSet_G ( groupId, dataCollectionId, dataSetId, start, end );
		else
			return structuredDataPersistence
						.findByCollectionSet_G_S ( groupId, dataCollectionId, dataSetId, start, end, status );
	}
	...
	public List<StructuredData> getStructuredDataByCollectionSet (
		...
		if ( status == WorkflowConstants.STATUS_ANY )
			return super.structuredDataPersistence
						.findByCollectionSet_G ( groupId, dataCollectionId, dataSetId, start, end, comparator );
		else
			return structuredDataPersistence.findByCollectionSet_G_S (
						groupId,
						dataCollectionId,
						dataSetId,
						start,
	...
	public List<StructuredData> getStructuredDatasByGroupId (
				long groupId, int start, int end, int status, OrderByComparator<StructuredData> comparator
	) {
		if ( status == WorkflowConstants.STATUS_ANY )
	...
	public List<StructuredData> getStructuredDatasByCollectionId (
				long dataTypeId, long groupId, int start, int end, OrderByComparator<StructuredData> comparator
	) {
	...
	public List<StructuredData> getStructuredDatasByUserId (
				long userId, int start, int end, OrderByComparator<StructuredData> comparator
	) {
	...
	public List<StructuredData> getStructuredDatasByDataTypeId_U (
				long dataTypeId, long userId, int start, int end, OrderByComparator<StructuredData> comparator
	) {
	...
	public List<StructuredData> getStructuredDatasByDataTypeId (
		...
		if ( status == WorkflowConstants.STATUS_ANY )
			...
			return super.structuredDataPersistence
						.findByDataTypeId_G_S ( groupId, dataTypeId, start, end, status, comparator );
	}
	...
	public List<StructuredData> getStructuredDatasByUserId (
				long userId, int start, int end, int status, OrderByComparator<StructuredData> comparator
	) {
		if ( status == WorkflowConstants.STATUS_ANY )
			return super.structuredDataPersistence.findByUserId ( userId, start, end );
		else
	...
	public List<StructuredData> getStructuredDatasByG_U_S (
				long groupId, long userId, int status, int start, int end, OrderByComparator<StructuredData> comparator
	) {
		if ( status == WorkflowConstants.STATUS_ANY )
	...
	public List<StructuredData> getStructuredDatasByCollectionSet (
		...
		if ( status == WorkflowConstants.STATUS_ANY )
			...
			return super.structuredDataPersistence
						.findByCollectionSet_G_S ( groupId, dataCollectionId, dataSetId, status );
	}
	...
	public List<StructuredData> getStructuredDatasByCollectionSet (
		...
		if ( status == WorkflowConstants.STATUS_ANY )
			...
			return super.structuredDataPersistence.findByCollectionSet_G_S (
						groupId,
						dataCollectionId,
						dataSetId,
						start,
	...
	public int countStructuredDatasByCollectionSet ( long groupId, long dataCollectionId, long dataSetId, int status ) {
		if ( status == WorkflowConstants.STATUS_ANY )
			...
			return super.structuredDataPersistence
						.countByCollectionSet_G_S ( groupId, dataCollectionId, dataSetId, status );
	}
	...
	public List<StructuredData> getStructuredDatasBySetType (
				long groupId, long dataSetId, long dataTypeId, int start, int end, int status
	) {
		if ( status == WorkflowConstants.STATUS_ANY )
			return super.structuredDataPersistence.findBySetType_G ( groupId, dataSetId, dataTypeId, start, end );
		else
			return super.structuredDataPersistence
						.findBySetType_G_S ( groupId, dataSetId, dataTypeId, start, end, status );
	}
	...
	public List<StructuredData> getStructuredDatasBySetType (
		...
		if ( status == WorkflowConstants.STATUS_ANY )
			return super.structuredDataPersistence
						.findBySetType_G ( groupId, dataSetId, dataTypeId, start, end, comparator );
		else
			return super.structuredDataPersistence
						.findBySetType_G_S ( groupId, dataSetId, dataTypeId, start, end, status, comparator );
	}
	...
	public List<StructuredData> getStructuredDatasByDataSetId (
		...
		if ( status == WorkflowConstants.STATUS_ANY )
			...
			return super.structuredDataPersistence
						.findByDataSetId_G_S ( groupId, dataSetId, start, end, status, comparator );
	}
	...
	public List<StructuredData> getStructuredDatasByCollectionSetType (
				long groupId, long dataCollectionId, long dataSetId, long dataTypeId, int status
	) {
		if ( status == WorkflowConstants.STATUS_ANY )
			return super.structuredDataPersistence
						.findByCollectionSetType_G ( groupId, dataCollectionId, dataSetId, dataTypeId );
			...
			return super.structuredDataPersistence
						.findByCollectionSetType_G_S ( groupId, dataCollectionId, dataSetId, dataTypeId, status );
	}

	public List<StructuredData> getStructuredDatasByCollectionSetType (
				long groupId, long dataCollectionId, long dataSetId, long dataTypeId, int start, int end, int status
	) {
		if ( status == WorkflowConstants.STATUS_ANY )
			return super.structuredDataPersistence
						.findByCollectionSetType_G ( groupId, dataCollectionId, dataSetId, dataTypeId, start, end );
		else
			return super.structuredDataPersistence.findByCollectionSetType_G_S (
						groupId,
						dataCollectionId,
						dataSetId,
						dataTypeId,
	...
	public List<StructuredData> getStructuredDatasByCollectionSetType (
		...
		if ( status == WorkflowConstants.STATUS_ANY )
			return super.structuredDataPersistence.findByCollectionSetType_G (
						groupId,
						dataCollectionId,
						dataSetId,
						dataTypeId,
	...
	public int countStructuredDatasByCollectionSetType (
		...
		if ( status == WorkflowConstants.STATUS_ANY )
			return super.structuredDataPersistence
						.countByCollectionSetType_G ( groupId, dataCollectionId, dataSetId, dataTypeId );
		else
			return super.structuredDataPersistence
						.countByCollectionSetType_G_S ( groupId, dataCollectionId, dataSetId, dataTypeId, status );
	}
	...
	public Path getDataFileFolder ( long companyId, long groupId, long structuredDataId ) {
	 ...
	 * structuredDataPersistence.findByCollectionSetType(dataCollectionId, dataSetId, dataTypeId, start,
	 * end); } else if( dataCollectionId > 0 && dataSetId > 0) { dataList =
	 ...
	 * dataSetId > 0 && dataTypeId > 0 ) { dataList = structuredDataPersistence.findBySetType(dataSetId,
	 * dataTypeId, start, end); } else if( dataSetId > 0 ) { dataList =
	 * structuredDataPersistence.findByDataSetId(dataSetId, start, end); } else if( dataTypeId > 0 ) {
	 * dataList = structuredDataPersistence.findByDataTypeId(dataTypeId, start, end); } else { dataList
	 * = structuredDataPersistence.findAll(start, end); }
	 * 
	...
	public JSONObject createStructuredDataInfo (
				JSONArray dataArray, long dataCollectionId, long dataSetId, long dataTypeId, Locale locale
	) {
	...
	public JSONObject getStructuredDataWithInfo ( long structuredDataId, Locale locale ) throws JSONException {
	...
	public SearchContainerResults<AssetEntry> getSearchContainerResults (
		...
		System.out.println (
					"StructuredDataLocalService.getSearchContainerResults Type: " + searchContainer.getOrderByType ()
		);
