 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.sx.icecap.service.impl.ActionHistoryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.sx.icecap.service.impl.ActionHistoryLocalServiceImpl
 * @generated
 */
public abstract class ActionHistoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements ActionHistoryLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ActionHistoryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ActionHistoryLocalServiceUtil</code>.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ActionHistory.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return actionHistoryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(
		...
		return actionHistoryPersistence.countWithDynamicQuery(
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(actionHistoryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ActionHistory.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("actionHistoryId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(ActionHistory.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return actionHistoryLocalService.deleteActionHistory(
			(ActionHistory)persistedModel);
	}

	public BasePersistence<ActionHistory> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ActionHistoryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		actionHistoryLocalService = (ActionHistoryLocalService)aopProxy;

		_setLocalServiceUtilService(actionHistoryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ActionHistoryLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = ActionHistoryLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, actionHistoryLocalService);
		}
	...
	protected ActionHistoryLocalService actionHistoryLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		ActionHistoryLocalServiceBaseImpl.class);
