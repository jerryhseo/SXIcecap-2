package com.sx.icecap.exportimport.data.handler.structureddata;
...
public class StructuredDataStagedModelDataHandler extends BaseStagedModelDataHandler<StructuredData> {
		...
		if (portletDataContext.isDataStrategyMirror()) {
			...
			if (existingData == null) {
				...
				importedData = _structuredDataLocalService.addStructuredData(
						structuredData.getDataCollectionId(), 
						structuredData.getDataSetId(), 
						structuredData.getDataTypeId(),
						structuredData.getMultiple(),
						structuredData.getStartIndex(),
						structuredData.getCount(),
						structuredData.getFreezed(),
						structuredData.getVerified(),
						structuredData.getComments(),
						structuredData.getHistory(),
				...
				importedData = _structuredDataLocalService.updateStructuredData(
						existingData.getStructuredDataId(), 
						structuredData.getDataCollectionId(), 
						structuredData.getDataSetId(), 
						structuredData.getDataTypeId(),
						structuredData.getMultiple(),
	...
	public String getDisplayName(StructuredData stagedModel) {
		return String.valueOf(stagedModel.getStructuredDataId());
	}
