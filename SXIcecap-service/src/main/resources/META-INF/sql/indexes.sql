...
create index IX_F11767BB on SX_ICECAP_StructuredData (dataSetId, dataCollectionId);
...
create index IX_C2A0199D on SX_ICECAP_StructuredData (dataSetId, groupId, dataCollectionId);
create index IX_89D50503 on SX_ICECAP_StructuredData (dataSetId, groupId, status, dataCollectionId);
create index IX_8907F157 on SX_ICECAP_StructuredData (dataSetId, groupId, userId, dataCollectionId);
create index IX_2C2E82BD on SX_ICECAP_StructuredData (dataSetId, groupId, userId, status, dataCollectionId);
create index IX_8B235521 on SX_ICECAP_StructuredData (dataSetId, status, dataCollectionId);
create index IX_8A564175 on SX_ICECAP_StructuredData (dataSetId, userId, dataCollectionId);
create index IX_C231D4DB on SX_ICECAP_StructuredData (dataSetId, userId, status, dataCollectionId);
...
create index IX_F35AF8BA on SX_ICECAP_StructuredData (dataTypeId, userId, status, dataCollectionId, dataSetId);
...
create index IX_9C7AA92E on SX_ICECAP_StructuredData (groupId, status, dataCollectionId, dataSetId, dataTypeId);
create index IX_75C92225 on SX_ICECAP_StructuredData (groupId, status, dataSetId, dataTypeId);
create index IX_2FE58124 on SX_ICECAP_StructuredData (groupId, status, dataTypeId);
...
create index IX_31CB8F34 on SX_ICECAP_StructuredData (groupId, userId, status, dataCollectionId, dataSetId, dataTypeId);
create index IX_5D739DAB on SX_ICECAP_StructuredData (groupId, userId, status, dataSetId, dataTypeId);
create index IX_3B34FD5E on SX_ICECAP_StructuredData (groupId, userId, status, dataTypeId);
create index IX_2138D7BA on SX_ICECAP_StructuredData (status, dataCollectionId, dataSetId, dataTypeId);
create index IX_AF461BB1 on SX_ICECAP_StructuredData (status, dataSetId, dataTypeId);
create index IX_D5450718 on SX_ICECAP_StructuredData (status, dataTypeId);
...
create index IX_6A182076 on SX_ICECAP_StructuredData (userId, status, dataCollectionId);
create index IX_544B37 on SX_ICECAP_StructuredData (userId, status, dataSetId, dataTypeId);
create index IX_F0794F52 on SX_ICECAP_StructuredData (userId, status, dataTypeId);
