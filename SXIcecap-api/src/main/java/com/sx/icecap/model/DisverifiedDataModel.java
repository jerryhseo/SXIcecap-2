...
/**
 * The base model interface for the DisverifiedData service. Represents a row in the &quot;SX_ICECAP_DisverifiedData&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.sx.icecap.model.impl.DisverifiedDataModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.sx.icecap.model.impl.DisverifiedDataImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface DisverifiedDataModel
	extends BaseModel<DisverifiedData>, GroupedModel, LocalizedModel,
			ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a disverified data model instance should use the {@link DisverifiedData} interface instead.
	 */
