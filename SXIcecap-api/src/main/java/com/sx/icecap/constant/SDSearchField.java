...
public class SDSearchField {
	...
	static public final String VALUES = "values";
	static public final String STATUS = "status";
	static public final String TERM_NAME = "termName";
	static public final String TERM_TYPE = "termType";
