...
public class DataSetUtil {
	 ...
	 */
	public static List<DataSet> filterFindByGroupId(long groupId) {
	 ...
	 */
	public static List<DataSet> filterFindByGroupId(
		long groupId, int start, int end) {
	 ...
	 * @throws NoSuchDataSetException if a data set with the primary key could not be found
	 */
	public static DataSet[] filterFindByGroupId_PrevAndNext(
			long dataSetId, long groupId,
			OrderByComparator<DataSet> orderByComparator)
		throws com.sx.icecap.exception.NoSuchDataSetException {
	 ...
	 * @return the matching data sets that the user has permission to view
	 */
	public static List<DataSet> filterFindByG_U(long groupId, long userId) {
	 ...
	 * @return the range of matching data sets that the user has permission to view
	 */
	public static List<DataSet> filterFindByG_U(
		long groupId, long userId, int start, int end) {
	 ...
	 * @throws NoSuchDataSetException if a data set with the primary key could not be found
	 */
	public static DataSet[] filterFindByG_U_PrevAndNext(
			long dataSetId, long groupId, long userId,
			OrderByComparator<DataSet> orderByComparator)
		throws com.sx.icecap.exception.NoSuchDataSetException {
	 ...
	 * @return the matching data sets that the user has permission to view
	 */
	public static List<DataSet> filterFindByG_S(long groupId, int status) {
	 ...
	 * @return the range of matching data sets that the user has permission to view
	 */
	public static List<DataSet> filterFindByG_S(
		long groupId, int status, int start, int end) {
	 ...
	 * @throws NoSuchDataSetException if a data set with the primary key could not be found
	 */
	public static DataSet[] filterFindByG_S_PrevAndNext(
			long dataSetId, long groupId, int status,
			OrderByComparator<DataSet> orderByComparator)
		throws com.sx.icecap.exception.NoSuchDataSetException {
	 ...
	 * @return the matching data sets that the user has permission to view
	 */
	public static List<DataSet> filterFindByG_U_S(
		long groupId, long userId, int status) {
	 ...
	 * @throws NoSuchDataSetException if a data set with the primary key could not be found
	 */
	public static DataSet[] filterFindByG_U_S_PrevAndNext(
			long dataSetId, long groupId, long userId, int status,
			OrderByComparator<DataSet> orderByComparator)
		throws com.sx.icecap.exception.NoSuchDataSetException {
	...
	public static void setPersistence(DataSetPersistence persistence) {
