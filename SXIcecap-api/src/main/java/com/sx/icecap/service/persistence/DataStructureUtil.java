...
public class DataStructureUtil {
	 ...
	 * @return the matching data structures
	 */
	public static List<DataStructure> findByCode(String dataStructureCode) {
		return getPersistence().findByCode(dataStructureCode);
	}
	 ...
	 * @return the range of matching data structures
	 */
	public static List<DataStructure> findByCode(
		String dataStructureCode, int start, int end) {

		return getPersistence().findByCode(dataStructureCode, start, end);
	}
	...
	public static List<DataStructure> findByCode(
		...
		return getPersistence().findByCode(
			dataStructureCode, start, end, orderByComparator, useFinderCache);
	}
	 ...
	 * @throws NoSuchDataStructureException if a matching data structure could not be found
	 */
	public static DataStructure findByCode_First(
	 ...
	 * @return the first matching data structure, or <code>null</code> if a matching data structure could not be found
	 */
	public static DataStructure fetchByCode_First(
		String dataStructureCode,
		OrderByComparator<DataStructure> orderByComparator) {
	 ...
	 * @throws NoSuchDataStructureException if a matching data structure could not be found
	 */
	public static DataStructure findByCode_Last(
			String dataStructureCode,
			OrderByComparator<DataStructure> orderByComparator)
		throws com.sx.icecap.exception.NoSuchDataStructureException {
	 ...
	 * @return the last matching data structure, or <code>null</code> if a matching data structure could not be found
	 */
	public static DataStructure fetchByCode_Last(
		String dataStructureCode,
		OrderByComparator<DataStructure> orderByComparator) {
	 ...
	 * @throws NoSuchDataStructureException if a data structure with the primary key could not be found
	 */
	public static DataStructure[] findByCode_PrevAndNext(
			long dataStructureId, String dataStructureCode,
			OrderByComparator<DataStructure> orderByComparator)
		throws com.sx.icecap.exception.NoSuchDataStructureException {

		return getPersistence().findByCode_PrevAndNext(
			dataStructureId, dataStructureCode, orderByComparator);
	}
	 ...
	 * @param dataStructureCode the data structure code
	 */
	public static void removeByCode(String dataStructureCode) {
		getPersistence().removeByCode(dataStructureCode);
	}
	 ...
	 * @return the number of matching data structures
	 */
	public static int countByCode(String dataStructureCode) {
		return getPersistence().countByCode(dataStructureCode);
	}
	 ...
	 * @throws NoSuchDataStructureException if a matching data structure could not be found
	 */
	public static DataStructure findByCodeVersion(
	 ...
	 * @return the matching data structure, or <code>null</code> if a matching data structure could not be found
	 */
	public static DataStructure fetchByCodeVersion(
		String dataStructureCode, String dataStructureVersion) {
	...
	public static DataStructure fetchByCodeVersion(
		...
		return getPersistence().fetchByCodeVersion(
			dataStructureCode, dataStructureVersion, useFinderCache);
	}
	 ...
	 * @return the data structure that was removed
	 */
	public static DataStructure removeByCodeVersion(
			String dataStructureCode, String dataStructureVersion)
		throws com.sx.icecap.exception.NoSuchDataStructureException {
	...
	public static void setPersistence(DataStructurePersistence persistence) {
